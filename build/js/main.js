...
jquery__WEBPACK_IMPORTED_MODULE_2___default()(".checkbox").on("click", function () {
  var values = [];
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(".checkbox:checked").each(function () {
    var e = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this);
    values.push(e.val());
  });
